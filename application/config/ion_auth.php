...
*/
$config['tables']['users']           = 'msi_users';
$config['tables']['groups']          = 'msi_groups';
$config['tables']['users_groups']    = 'msi_users_groups';
$config['tables']['login_attempts']  = 'msi_login_attempts';
